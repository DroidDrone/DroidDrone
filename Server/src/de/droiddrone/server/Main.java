...
public class Main {
	final static int versionCode = 4;
	final static String versionName = "1.2.2";
	...
	public static void main(String[] args) {
		...
		try (Scanner console = new Scanner(new InputStreamReader(System.in, StandardCharsets.UTF_8))) {
